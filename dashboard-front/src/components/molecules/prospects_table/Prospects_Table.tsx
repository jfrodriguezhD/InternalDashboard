...
function Prospects_Table() {
    ...
    return (
        ...
        <div className="prospects__table__row__container">
            {tempList.length>0?<ProspectView prospect={tempList[selectedRow]} toggleDialog={toggleView} ref={viewRef} />:null}
